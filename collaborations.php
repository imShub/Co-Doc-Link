                ...
                <div class="content-wrapper">
                    <div class="row">
                        ...
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Create New Workplace </h4>
                                    <p class="card-description">
                                        <?php
                                    if (isset($_SESSION['new_folder_created'])) {
                                        ?>
                                    <div id="notification" class="alert alert-success" role="alert">
                                        <b> <i class="bi bi-check-circle-fill"></i>Success ! </b>New Workplace created
                                        successfully.
                                    </div>
                                    <?php
                                       unset($_SESSION['new_workplace_created']);
                                    }
                                    ?>
                                    
                                    
                                    </p>
                                    <form class="forms-sample" action="php/add_new_workspace.php" method="post">
                                        <div class="form-group">
                                            <label for="exampleInputUsername1">Name </label>
                                            <input type="text" name="workplace" class="form-control"
                                                id="exampleInputUsername1" placeholder="Workplace Name" required>
                                        </div>
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title"> Workplace #1 </h4>
                                    <p class="card-description">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <?=$sfrow['sf_name']?>
                                                        <a href="share_folder_documents.php?id=<?=$sfrow['sf_id']?>"
                                                            class="btn btn-xs btn-inverse-success fs-9 rounded">Online</a>
                                                    ...
                                                    <td>
                                                        <button type="button"
                                                            class="btn btn-inverse-success btn-sm rounded"
